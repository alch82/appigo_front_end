...
@Component({
    ...
    styleUrls: ['../../../assets/css/list-editors.css', 'smart-list-edit-filter-row.component.css', 'smart-list-edit.component.css']
})
export class SmartListEditFilterRow implements OnInit {
    ...
    constructor(private readonly membershipService : TCListMembershipService) {}
