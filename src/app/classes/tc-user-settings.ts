...
export class TCUserSettings extends TCObject {
    ...
    public readonly userInbox       : string
    ...
    constructor(json? : any) {
        ...
        this.assignIfExists(json.user_inbox, 'userInbox')
    }
...
export class TCUserSettingsUpdate extends TCUserSettings {
    ...
    requestBody() {
        ...
        if (body.all_list_filter_string.length == 0) delete body.all_list_filter_string
