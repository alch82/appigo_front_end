...
export class PaywallService {
    ...
    paywallCheck(paywallMessage : string, onActiveSubscription : () => void) {
        ...
        this.subscription.isActive ? onActiveSubscription() : this.createPaywallEventWithMessage(paywallMessage)
    }
