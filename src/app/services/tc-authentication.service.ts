...
export class TCAuthenticationService {
    public readonly authStateChanged : Observable<boolean>
    public token    : string
    private headers : Headers
    private _authStateChanged : Subject<boolean>
    ...
    constructor(
        ...
        this._authStateChanged = new Subject()
        this.authStateChanged = this._authStateChanged
    }
    ...
    needsTokenRefresh() : boolean {
        ...
        const expirationOffset : number = 60
